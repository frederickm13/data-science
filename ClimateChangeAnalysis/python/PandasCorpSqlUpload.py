...
file_names = [
    "../hidden/2018_Full_Climate_Change_Dataset.csv",
    "../hidden/2019_Full_Climate_Change_Dataset.csv",
    "../hidden/2020_Full_Climate_Change_Dataset.csv",
    "../hidden/2018_Full_Water_Security_Dataset.csv",
    "../hidden/2019_Full_Water_Security_Dataset.csv",
    "../hidden/2020_Full_Water_Security_Dataset.csv"
]
...
with engine.connect() as conn:
    for file_name in file_names:
        ...
        # Upload to SQL.
        df.to_sql("corp_questions_csv", con=conn, if_exists="append", index=False, chunksize=chunk_size)
